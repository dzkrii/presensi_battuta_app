...
mixin _$User {
  ...
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(int id, String name, String email, String? image)
        model,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(int id, String name, String email, String? image)? model,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
class _$UserModelImpl implements UserModel {
  ...
  @override
  String toString() {
    return 'User.model(id: $id, name: $name, email: $email, image: $image)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return model(id, name, email, image);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return model?.call(id, name, email, image);
  }
